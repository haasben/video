<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:52:"D:\WWW\video/application/index\view\member\index.htm";i:1575878712;s:46:"D:\WWW\video\application\index\view\search.htm";i:1573528354;s:49:"D:\WWW\video\application\index\view\haslogged.htm";i:1573701866;s:46:"D:\WWW\video\application\index\view\footer.htm";i:1573700790;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
					...
					<div class="centerLeft">
						<ul class="leftMenu clearfix">
							...
							<li class="" data-name="zw_5">
								<a href="javascript:" class="fw" style="background: url(static/images/bg_20130926001.gif) no-repeat scroll 60px 0px transparent;">购买会员</a>
							</li>
					...
					<div class="centerRight" id="zw_5" style="display: none;">
						...
						<div class="record">
							<table>
								...
								<tbody>
									<?php if(is_array($memberData['member_level']) || $memberData['member_level'] instanceof \think\Collection || $memberData['member_level'] instanceof \think\Paginator): $i = 0; $__LIST__ = $memberData['member_level'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
									<tr>
...
<!-- 							
							<div class="pay">
								<div class="">
									...
									<img src="/public/static/index//images/w.png" >
								</div>
								<div class="">
									<input type="radio" name="pay" value="" />
									<img src="/public/static/index//images/z.png" >
								</div>
							</div> -->
							...
							<script type="text/javascript">
								$(function(){
									$('.pay_btn').click(function(){
										...
										var token = "<?php echo $memberData['token']; ?>";
