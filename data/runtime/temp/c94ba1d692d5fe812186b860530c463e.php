<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\phpStudy\PHPTutorial\WWW\video/application/mobile\view\product\index.htm";i:1574391133;s:68:"D:\phpStudy\PHPTutorial\WWW\video\application\mobile\view\footer.htm";i:1574329228;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
					...
					<ul style="padding-top: 0.1rem;">
						...
						<li>
							<a href="javascript:" class="see" role="button" data-id="<?php echo $v['aid']; ?>">
								<img class="lazy" src="<?php echo $v['litpic']; ?>" class="img-responsive" alt="<?php echo $v['title']; ?>" />
