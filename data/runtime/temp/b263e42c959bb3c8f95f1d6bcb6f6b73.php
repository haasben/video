<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpStudy\PHPTutorial\WWW\video/application/mobile\view\m_free_course\index.htm";i:1574221322;s:68:"D:\phpStudy\PHPTutorial\WWW\video\application\mobile\view\footer.htm";i:1574329228;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
							...
							<img class="lazy" src="<?php echo $f['litpic']; ?>" height="100" class="img-responsive" alt="" />
								<h5><?php echo $f['title']; ?></h5>
									<div class="info">
										...
										<p><a href="mcourse_show?id=<?php echo $f['aid']; ?>">免费观看</a></p>
									</div>
							</a>
						</li>
