<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\phpStudy\PHPTutorial\WWW\video/application/index\view\productcenter\details.htm";i:1573699457;s:67:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\search.htm";i:1573528354;s:70:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\haslogged.htm";i:1573701866;s:67:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\footer.htm";i:1573700791;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
	<head>
		<meta charset="utf-8">
						...
						<div class="show_content padding-large-bottom padding-large-top content_detail">
							<div class="show_body detail">
								...
								<div class="description"> 
									...
									<!--分享begin-->
									<div>
										<?php if(is_array($archives['img']) || $archives['img'] instanceof \think\Collection || $archives['img'] instanceof \think\Paginator): $i = 0; $__LIST__ = $archives['img'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
										<img src="<?php echo $v['image_url']; ?>" title="<?php echo $v['title']; ?>">
											<?php endforeach; endif; else: echo "" ;endif; ?>
									</div>
			
									<!--分享 end-->
									<ul class="pager padding-big-top padding-big-bottom">
										<li>上一篇：<?php if(empty($pre) || (($pre instanceof \think\Collection || $pre instanceof \think\Paginator ) && $pre->isEmpty())): ?>没有更多了<?php else: ?><a href='<?php echo url("index/productcenter/details"); ?>&id=<?php echo $pre['aid']; ?>'><?php echo $pre['title']; ?></a> <?php endif; ?>
										</li>
										<li>下一篇：<?php if(empty($next) || (($next instanceof \think\Collection || $next instanceof \think\Paginator ) && $next->isEmpty())): ?>没有更多了<?php else: ?><a href='<?php echo url("index/productcenter/details"); ?>&id=<?php echo $next['aid']; ?>'><?php echo $next['title']; ?></a><?php endif; ?>
										 </li>
									</ul>
								</div>
							</div>
