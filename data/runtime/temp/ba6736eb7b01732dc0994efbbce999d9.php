<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:47:"./application/admin/template/download\index.htm";i:1574214810;s:78:"D:\phpStudy\PHPTutorial\WWW\video\application\admin\template\public\layout.htm";i:1571037616;s:76:"D:\phpStudy\PHPTutorial\WWW\video\application\admin\template\article\bar.htm";i:1571037616;s:82:"D:\phpStudy\PHPTutorial\WWW\video\application\admin\template\archives\tags_btn.htm";i:1571037616;s:78:"D:\phpStudy\PHPTutorial\WWW\video\application\admin\template\public\footer.htm";i:1571037616;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table cellspacing="0" cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <th abbr="download_title" axis="col3" class="">
                            <div style="text-align: left; padding-left: 10px;" class="">课程标题</div>
                        </th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="tc w50">
                                    <?php if($vo['is_recom'] == 1): ?>
                                        <span class="yes" <?php if(is_check_access(CONTROLLER_NAME.'@edit') == '1'): ?>onClick="changeTableVal('course','aid','<?php echo $vo['aid']; ?>','is_recom',this);"<?php endif; ?> ><i class="fa fa-check-circle"></i>是</span>
                                    <?php else: ?>
                                        <span class="no" <?php if(is_check_access(CONTROLLER_NAME.'@edit') == '1'): ?>onClick="changeTableVal('course','aid','<?php echo $vo['aid']; ?>','is_recom',this);"<?php endif; ?> ><i class="fa fa-ban"></i>否</span>
                                    <?php endif; ?>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="w180 tc">
                                   ...
                                   <a href="<?php echo url('Download/chapter',array('id'=>$vo['aid'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>章节</a>
                                   <a href="<?php echo url('Download/course_index',array('typeid'=>$vo['typeid'],'id'=>$vo['aid'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>视频</a>
                            ...
                            <td class="sort">
                                <div class="w60 tc">
                                    <?php if(is_check_access(CONTROLLER_NAME.'@edit') == '1'): ?>
                                    <input type="text" onchange="changeTableVal('course','aid','<?php echo $vo['aid']; ?>','sort_order',this);"  size="4"  value="<?php echo $vo['sort_order']; ?>" />
                                    <?php else: ?>
