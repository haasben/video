<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpStudy\PHPTutorial\WWW\video/application/index\view\course_center\video_play.htm";i:1573782308;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1,user-scalable=no" />
		<title><?php echo $course['seo_title']; ?></title>
	...
	<body style="height: 100% !important;overflow: hidden;">
		<div class="video_wrap">
			...
			<!--侧栏伸展-->
			<div class="menu">
				<!-- <div class="collapse-aside abs">
					<a class="fs f12 collapse-menu" title="展开菜单" href="javascript:void(0)">&gt;&gt;</a>
				</div> -->
				<div class="clearfix collapse collapse-wrap">
					...
					<div class="Tab">
						<ul>
							<li>
								<img src="/public/static/index/picture/icon-ml.png" alt="">
								目录</li>
						</ul>
					</div>
										...
										<ul>
											...
											<li class="rel">
												<a id="lesson_id_<?php echo $cl['aid']; ?>" class="ellipsis " href="/video_play?aid=<?php echo $cl['aid']; ?>" title="<?php echo $cl['title']; ?>">
													...
													<?php endif; ?>
													<span class="pl10"><?php if($cl['arcrank'] == 1): ?><b class="Watch-permissions abs">免费</b><?php endif; ?><?php echo $cl['title']; ?></span>
