<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\phpStudy\PHPTutorial\WWW\video/application/index\view\pay\paycourse.htm";i:1574234462;s:67:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\search.htm";i:1573528354;s:70:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\haslogged.htm";i:1573701866;s:67:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\footer.htm";i:1573700791;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<body>
		...
		<script type="text/javascript">
			...
			<div class="container">
				<div class="inner mt20">
					...
					<div class="pay_method">
						<div class="orderId">
							<span>订单号：</span><span class="order_code"><?php echo $order['order_info']['order_code']; ?></span>
						</div>
						<div class="allCount">
							本次应支付：<span><?php echo $order['order_info']['order_total_amount']; ?></span>元
						</div>
						<div class="method">
							<p>请选择支付方式</p>
							<div class="">

								<?php if($order['pay_alipay_config']['is_open_alipay'] === '0'): ?>
								<a href="<?php echo url('index/Pay/new_alipay_pay_url'); ?>&order_code=<?php echo $order['order_info']['order_code']; ?>&token=<?php echo $token; ?>&transaction_type=2"  id="alipay">
									<img src="/public/static/index/picture/zhi.jpg" >
								</a>
								<?php endif; if($order['pay_wechat_config']['is_open_wechat'] === '0'): ?>
			...
			<input type="hidden" name="" class="transaction_type" value="2">
   ...
   "margin-bottom":"24px"
			...
			<div class="wx_qr">
				<div class="wrap">
					...
					<div class="content">
						<span>微信扫一扫付款</span>
						<span>￥<?php echo $order['order_info']['order_total_amount']; ?></span>
