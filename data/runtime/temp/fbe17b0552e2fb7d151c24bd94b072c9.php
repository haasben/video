<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"./application/admin/template/download\course_edit.htm";i:1575604444;s:57:"D:\WWW\video\application\admin\template\public\layout.htm";i:1571037616;s:57:"D:\WWW\video\application\admin\template\public\footer.htm";i:1571037616;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="min-width:auto;">
 ...
 <!--                <li><a href="javascript:void(0);" data-index='2' class="tab"><span>SEO选项</span></a></li>
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Download/course_edit'); ?>" method="post">
        <!-- 常规信息 -->
        <div class="ncap-form-default tab_div_1">
            ...
            <dl class="row">
                ...
                <dd class="opt"> 
                    <select name="cha_id" id="cha_id">
                        <option value="0">选择所属章节</option>
                        <?php if(is_array($chapter) || $chapter instanceof \think\Collection || $chapter instanceof \think\Paginator): $i = 0; $__LIST__ = $chapter;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $c['id']; ?>" <?php if($c['id'] == $field['cha_id']): ?> selected="selected" <?php endif; ?>><?php echo $c['title']; ?></option>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="radio" name="arcrank" value="0" <?php if($field['arcrank'] == 0): ?> checked="checked" <?php endif; ?>>收费

                    <input type="radio" name="arcrank" value="1" <?php if($field['arcrank'] == 1): ?> checked="checked" <?php endif; ?>>免费
        ...
        <input type="hidden" name="cou_id" value="<?php echo $field['cou_id']; ?>">
            <dl class="row">
                <dt class="tit">
                  <label>上传文件</label>
                </dt>
                                ...
                                <tbody id="demoList">
                                    <?php if(is_array($downfile_list) || $downfile_list instanceof \think\Collection || $downfile_list instanceof \think\Paginator): $i = 0; $__LIST__ = $downfile_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(empty($vo['is_remote']) || (($vo['is_remote'] instanceof \think\Collection || $vo['is_remote'] instanceof \think\Paginator ) && $vo['is_remote']->isEmpty())): ?>
                                            <tr>
                                                ...
                                                <td><?php echo round($vo['file_size']/1024,2); ?> MB</td>
