<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\phpStudy\PHPTutorial\WWW\video/application/index\view\training_case\details.htm";i:1573699487;s:67:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\search.htm";i:1573528354;s:70:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\haslogged.htm";i:1573701866;s:67:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\footer.htm";i:1573700791;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
	<head>
		<meta charset="utf-8">
							...
							<div class="show_body detail">
								...
								<div class="description"> 
									...
									<ul class="pager padding-big-top padding-big-bottom">
										<li>上一篇：<?php if(empty($pre) || (($pre instanceof \think\Collection || $pre instanceof \think\Paginator ) && $pre->isEmpty())): ?>没有更多了<?php else: ?><a href='<?php echo url("index/trainingCase/details"); ?>&id=<?php echo $pre['aid']; ?>'><?php echo $pre['title']; ?></a> <?php endif; ?>
										</li>
										<li>下一篇：<?php if(empty($next) || (($next instanceof \think\Collection || $next instanceof \think\Paginator ) && $next->isEmpty())): ?>没有更多了<?php else: ?><a href='<?php echo url("index/trainingCase/details"); ?>&id=<?php echo $next['aid']; ?>'><?php echo $next['title']; ?></a><?php endif; ?>
										 </li>
									</ul>
								</div>
							</div>
