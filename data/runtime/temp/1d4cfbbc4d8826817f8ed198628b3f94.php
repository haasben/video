<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"D:\phpStudy\PHPTutorial\WWW\video/application/index\view\project_cases\index.htm";i:1573701176;s:67:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\search.htm";i:1573528354;s:70:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\haslogged.htm";i:1573701866;s:72:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\course_cate.htm";i:1573105650;s:67:"D:\phpStudy\PHPTutorial\WWW\video\application\index\view\footer.htm";i:1573700791;}*/ ?>
<!doctype html>
<html>
	<head>
		<meta charset="utf-8">
		<meta http-equiv="X-UA-Compatible" content="IE=edge">
		<title>项目案例-工控自动化视频课程中心</title>
				...
				<div class="inner mt20 oh" id="center">
					...
					<div class="inner oh">
						<ul class="listview13 clearfix" style="width:1220px;">
							...
							<li>
								<div class="li-img">
									<a href="<?php echo url('index/projectCases/details'); ?>&id=<?php echo $c['aid']; ?>" class="title" id="title" data-id="6431" target="_index">
										<img src="<?php echo $c['litpic']; ?>" width="263" height="150" alt="<?php echo $c['title']; ?>" class="lazy" />
									</a>
								</div>
								<p class="h40 mt5 lh20 f16"><a href="<?php echo url('index/projectCases/details'); ?>&id=<?php echo $c['aid']; ?>"><?php echo $c['title']; ?></a></p>
							</li>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
					</div>
