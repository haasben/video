<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:55:"./application/admin/template/member\users_batch_add.htm";i:1575617666;s:57:"D:\WWW\video\application\admin\template\public\layout.htm";i:1571037616;s:62:"D:\WWW\video\application\admin\template\member\users_field.htm";i:1571037616;s:57:"D:\WWW\video\application\admin\template\public\footer.htm";i:1571037616;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title"><a class="back" href="<?php echo url('Member/users_index'); ?>" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
            <div class="subject">
                <h3>会员中心 - 批量新增会员</h3>
                <h5></h5>
            </div>
        ...
        <div class="ncap-form-default">
            ...
            <input type="hidden" id="level_member_upgrade" value="<?php echo (isset($userConfig['level_member_upgrade']) && ($userConfig['level_member_upgrade'] !== '')?$userConfig['level_member_upgrade']:'0'); ?>">
             <dl class="row"  id='users_days_level'>
                ...
                <dd class="opt">
                    <?php if(is_array($user_level) || $user_level instanceof \think\Collection || $user_level instanceof \think\Paginator): $i = 0; $__LIST__ = $user_level;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?>
                    <input type="checkbox" name="view_rights[]" value="<?php echo $l['level_id']; ?>"><?php echo $l['level_name']; endforeach; endif; else: echo "" ;endif; ?>
                </dd>
            </dl>
