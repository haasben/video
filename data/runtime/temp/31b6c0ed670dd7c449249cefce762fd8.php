<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\WWW\video/application/mobile\view\m_course_center\mcourse_show.htm";i:1575862066;s:47:"D:\WWW\video\application\mobile\view\footer.htm";i:1574329228;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<body>
		<div class="wrap">
			...
			<div class="container detail">
				<div class="video">
					<video width="100%" controls poster="<?php echo $course_info['litpic']; ?>" controlslist="nodownload noremoteplayback" class="vid" id="vid" webkit-playsinline="" playsinline="" preload="metadata" id="vid">
				...
				<div class="title-wrap">
					...
					<div class="zx">
						...
						<p class="price">
							...
							<?php if($course_info['is_free'] == '收费'): if(!in_array($course_info['level'],$userData['view_rights'])): if(empty($mainCourse) || (($mainCourse instanceof \think\Collection || $mainCourse instanceof \think\Paginator ) && $mainCourse->isEmpty())): ?>
				...
				<div class="course_nav">
					...
					<div class="course_list zw" id="zw1">
						<ul>
						<?php if(is_array($course_info['list']) || $course_info['list'] instanceof \think\Collection || $course_info['list'] instanceof \think\Paginator): $k = 0; $__LIST__ = $course_info['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;if(in_array($course_info['level'],$userData['view_rights'])): ?>
		...
		function get_blob_video(data_id,id){
			...
			// console.log(xhr);
			xhr.open('POST',"<?php echo url('mobile/MCourseCenter/get_video_url'); ?>&aid="+data_id+'&id='+id,true);
