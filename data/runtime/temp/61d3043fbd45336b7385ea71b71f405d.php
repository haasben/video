<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:50:"./application/admin/template/member\users_edit.htm";i:1575616986;s:57:"D:\WWW\video\application\admin\template\public\layout.htm";i:1571037616;s:62:"D:\WWW\video\application\admin\template\member\users_field.htm";i:1571037616;s:57:"D:\WWW\video\application\admin\template\public\footer.htm";i:1571037616;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title"><a class="back" href="<?php echo $backurl; ?>" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
            <div class="subject">
                <h3>会员中心 - 编辑会员</h3>
                <h5></h5>
            </div>
    ...
    <form class="form-horizontal" id="postForm" action="<?php echo url('Member/users_edit'); ?>" method="post">
        <div class="ncap-form-default">
            ...
            <input type="hidden" id="level_member_upgrade" value="<?php echo (isset($userConfig['level_member_upgrade']) && ($userConfig['level_member_upgrade'] !== '')?$userConfig['level_member_upgrade']:'0'); ?>">
             ...
             <dl class="row"  id='users_days_level'>
                    <dt class="tit">
                        <label for="users_days_level"><em>*</em>观看视频权限</label>
                    </dt>
                    <dd class="opt">
                        <?php if(is_array($level) || $level instanceof \think\Collection || $level instanceof \think\Paginator): $i = 0; $__LIST__ = $level;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?>
                        <input type="checkbox" name="view_rights[]" 
                        <?php if(in_array($l['level_id'], $info['view_rights'])){echo 'checked="checked"';}; ?> value="<?php echo $l['level_id']; ?>"><?php echo $l['level_name']; endforeach; endif; else: echo "" ;endif; ?>
                    </dd>
                </dl>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="users_money" id="users_money" value="<?php echo (isset($info['users_money']) && ($info['users_money'] !== '')?$info['users_money']:'0.00'); ?>">&nbsp;元
                    <p class="notic"></p>
                </dd>
            </dl>
            <?php endif; ?>
