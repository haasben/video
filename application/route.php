...
$route = array(
    ...
    'FreeCourse'=>'index/FreeCourse/index',
    'CourseCenter'=>'index/CourseCenter/index',
    'login'=>'index/login/login',
    'member'=>'index/member/index',
    'category'=>'index/CourseCenter/category',
    'productcenter'=>'index/Productcenter/index',
    'ProjectCases'=>'index/ProjectCases/index',
    'TrainingCase'=>'index/TrainingCase/index',
    'Introduction'=>'index/Introduction/index',
    'contactus'=>'index/contactus/index',
    'course_show'=>'index/course_center/course_show',
    'video_play'=>'index/course_center/video_play',
    'get_video'=>'index/course_center/get_video',
    'member'=>'index/member/index',
    'search'=>'index/FreeCourse/search',
    'voice'=>'index/voice/voice_play',
    'paycourse'=>'index/pay/paycourse',
    'activation'=>'index/pay/activation',
    'Download'=>'index/Download/index',
    'wechat_qrpay_notify'=>'index/pay/wechat_qrpay_notify',
    'Affiliate'=>'index/Affiliate/index',
    'hyqx'=>'index/Affiliate/index',
    'CaseCourse'=>'index/CaseCourse/index',
    'Live'=>'index/Live/index',
    
    'm'=>'mobile/index/index',
    'MCourseCenter'=>'mobile/mCourseCenter/index',
    'MFreeCourse' =>'mobile/MFreeCourse/index',
    'mcategory'=>'mobile/mCourseCenter/mcategory',
    'mvoice'=>'mobile/mvoice/voice_play',
    'mcourse_show'=>'mobile/mCourseCenter/mcourse_show',
    'mlogin'=>'mobile/mlogin/login',
    'mregister'=>'mobile/mlogin/register',
    'update_pwd'=>'mobile/mlogin/update_pwd',
    'Mmember'=>'mobile/member/index',
    'learn'=>'mobile/member/learn',
    'MTrainingCase'=>'mobile/Training/index',
    'MProjectCases'=>'mobile/Project/index',
    'MCaseCourse'=>'mobile/CaseCourse/index',
    'Mproductcenter'=>'mobile/product/index',
    'MAffiliate'=>'mobile/Affiliate/index',
    'msearch'=>'mobile/search/index',
    
    'MLive'=>'mobile/live/index',
    // 'mpaycourse'
);
    ...
    if (3 == $seo_pseudo) {
        ...
        if (1 == $seo_rewrite_format) { // 精简伪静态
            $home_rewrite = array(
                ...
                // $lang_rewrite_str.'indexs$' => array('index/index/index',array('ext' => ''), 'cache'=>1),
